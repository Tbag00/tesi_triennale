...
\hline
\end{tabular}
\caption{Statistiche globali del dataset post pulizia (totale annunci: 5357).}
...
\section{Tuning congiunto di UMAP e HDBSCAN}
...
\subsection{N\_neighbors e min\_samples}
...
\subsection{Selezione della run rappresentativa}
